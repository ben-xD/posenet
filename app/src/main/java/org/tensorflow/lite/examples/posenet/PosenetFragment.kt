...
//        rgbBytes = IntArray(PREVIEW_WIDTH * PREVIEW_HEIGHT)
    ...
    override fun onResume() {
        ...
        imageReader =
            ImageReader.newInstance(PREVIEW_WIDTH, PREVIEW_HEIGHT, ImageFormat.YUV_420_888, 2)
...
//    mediaPlayer?.start()
//    Log.d(TAG, "surfaceCreated: mediaPlayer video dimensions ${mediaPlayer!!.videoWidth} by ${mediaPlayer!!.videoHeight}")
//  }
//
...
//    tensorFlowJob?.cancel("Stopping tensorflow lite processing as surface was destroyed.")
//    tensorFlowJob = null
//  }
}
